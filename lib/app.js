...
class App extends _react.Component {
  ...
  render() {
    const {
      ...
      Switch,
      withRouter
    } = this.props.react_router_instance || require('react-router-dom');
    ...
    if (this.state.error500) {
      ...
      return this.state.errorPages[500] ? /*#__PURE__*/_react.default.createElement(StaticRouter, {
        location: location
    ...
    }, !this.state.entry_state.is_fetching && /*#__PURE__*/_react.default.createElement(Switch, null, this.state.routes.filter(route => route.path).map(route => {
      return /*#__PURE__*/_react.default.createElement(Route, {
        exact: true,
        path: route.path,
        key: `default-router-${route.path}`,
        component: () => /*#__PURE__*/_react.default.createElement(Wrapper, {
          route: route,
          context: this.state.context,
          is_server: this.state.is_server,
          is_fetching: this.state.is_fetching,
    ...
    }), !!this.state.errorPages[404] && /*#__PURE__*/_react.default.createElement(Route, {
      path: "*",
      status: 404,
